...
// System.out.println("orderDone.jsp oinfoDTO " + oinfoDTO);
 ...
 List<OrderItemDTO> oList = (List<OrderItemDTO>)request.getAttribute("oitemList");
...
<div class="outer">
	...
	<table  width="100%">
		...
		<%
			...
			for(int i=0;i<oList.size();i++){
				OrderItemDTO oitemDTO = oList.get(i);
		...
		<tr>
			...
			<td align="center" height="35">
				<span><%= sum + OrderInfo_Delivery %></span>원
			</td>
		</tr>
		<tr>
			<td colspan="4">
	...
	<table width="100%">
		...
		<tr>
			...
			<td height="35"><span><%= sum%></span>원</td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td height="35"><span><%= sum + OrderInfo_Delivery %></span>원</td>
		</tr>
		<tr>
