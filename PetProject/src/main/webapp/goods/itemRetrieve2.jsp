...
<div class="goods_top">
	...
	<div class="goods_img">
		<!-- 상품 이미지 -->
		<img name="Item_Image" src="images/items/<%=itemImage%>.png"
	...
	<div class="goods_option">
		...
		<table border="1">
			<tr height="40px">
				<!-- 
	<tr>
		<td><a href="#"><span name="Item_Category" style="font-size:12px"itemCategoryory %></span></a></td>
		<td>
		<td>
	</tr>
	 -->
			<tr height="15px">
			<tr>
				<td colspan="3"><span name="Item_Name"
					style="font-size: 25px; font-weight: bold;"><%=itemName%></span></td>
			</tr>
			<tr height="5px">
			<tr>
				<td colspan="4"><span id="itemPrice"
					style="font-size: 25px; font-weight: bold;"><%=itemPrice%></span>
					<span style="font-size: 23px; font-weight: bold;">원</span></td>
			</tr>
			<!-- 	<tr height="20" />
	<tr rowspan="2"> 
		<td> -->
		...
		/*		if (itemSize != null) {
				...
				<%
					String[] sizeOption = itemSize.split("/");
				%>
	
				<td><select id="itemSize" name="Cart_Size">
				...
				<td><select id="itemColor" name="Cart_Color">
						<option selected>선택하세요</option>
				</select></td>
				
				<td><select id="itemTaste" name="Cart_Taste">
						<option selected>선택하세요</option>
				</select></td>
			</tr>
			...
			<tr>
				<td colspan="3">수량</td>
				<td><img src="images/icon/minus.png" id="down" width="10"
					height="10"> <input type="text" id="item_amount"
					name="item_amount" value="1"
					style="width: 25px; text-align: center;"> <img
					src="images/icon/plus.png" id="up" width="10"></td>
			</tr>
			<tr height="10" />
			<tr>
