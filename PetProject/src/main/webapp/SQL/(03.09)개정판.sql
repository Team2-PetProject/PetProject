...
-----------------------------
  ...
  (  
ORDERINFO_CODE NUMBER(10,0) PRIMARY KEY, --장바구니 번호
MEMBER_CODE VARCHAR2(20)NOT NULL,
ITEM_CODE VARCHAR2(10) NOT NULL, --상품번호
ITEM_NAME VARCHAR2(50) NOT NULL, --상품이름
ITEM_PRICE NUMBER(7,0) NOT NULL, --상품가격

CART_AMOUNT NUMBER(2,0) NOT NULL, --상품갯수
ITEM_IMAGE VARCHAR2(20) NOT NULL, --상품이미지
...
(
ORDERITEM_CODE NUMBER(10,0) PRIMARY KEY,
ITEM_CODE VARCHAR2(10) NOT NULL,
