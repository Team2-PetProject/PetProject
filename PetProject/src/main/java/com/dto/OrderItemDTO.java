...
public class OrderItemDTO {
	...
	public OrderItemDTO(int orderItem_Code, String item_Code, String member_Code, String order_Name, int cart_Amount,
			int item_Price, String item_Image, String cart_Size, String cart_Color, String cart_Taste,
			String orderInfo_Code, String item_Name) {
		super();
	...
	public String toString() {
		return "OrderItemDTO [OrderItem_Code=" + OrderItem_Code + ", Item_Code=" + Item_Code + ", Member_Code="
				+ Member_Code + ", Order_Name=" + Order_Name + ", Cart_Amount=" + Cart_Amount + ", Item_Price="
				+ Item_Price + ", Item_Image=" + Item_Image + ", Cart_Size=" + Cart_Size + ", Cart_Color=" + Cart_Color
				+ ", Cart_Taste=" + Cart_Taste + ", OrderInfo_Code=" + OrderInfo_Code + ", Item_Name=" + Item_Name
				+ "]";
	}
